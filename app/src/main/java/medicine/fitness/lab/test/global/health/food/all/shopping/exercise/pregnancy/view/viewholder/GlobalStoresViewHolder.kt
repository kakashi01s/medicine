...
class GlobalStoresViewHolder(itemView: View) : BaseViewHolder<List<String>, GlobalStoresItemClickListener<List<String>>>(itemView) {
    ...
    override fun onBind(item: List<String>, listener: GlobalStoresItemClickListener<List<String>>?) {
